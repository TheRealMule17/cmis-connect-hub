        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="mb-8">
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              ...
              <p>
                We provide a comprehensive platform for networking, mentorship, professional development, and
                collaboration opportunities that bridge academic learning with real-world industry experience.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              <div>
                ...
                <p>
                  Access to events, networking opportunities, mentorship programs, job tracking, and skill development
                  resources.
                </p>
              </div>
              <div>
                ...
                <p>
                  Mentorship opportunities, career networking, giving back programs, and staying connected with the
                  community.
                </p>
              </div>
              <div>
                ...
                <p>
                  Event management tools, analytics dashboards, research collaboration, and student engagement tracking.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-foreground mb-2">For Industry Sponsors</h3>
                <p>
                  Recruitment opportunities, event sponsorship, speaking engagements, and talent pipeline development.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <section className="mt-8 md:mt-16">
            ...
            <p className="text-sm sm:text-base text-center text-muted-foreground mb-8 md:mb-12 max-w-2xl mx-auto px-4">
              Our dedicated student leaders who help shape the future of CMIS and bridge the gap between students and
              faculty.
            </p>
